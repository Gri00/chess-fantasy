...
import { getLiveTVChannels, getGame, fenFromMoves } from "../services/lichess.js";

// Shown when Lichess TV returns nothing (rare but can happen during maintenance)
const MOCK_MOVES = "e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8 Nc3 Be6 b3 h6 Bb2 Kc8 Rad1 Be7 Nd4 Nxd4 Rxd4 Bd5 f3 a5 Rfd1"
...
const MOCK_LIST = [
  {
    id:      "mock_demo",
    variant: "Classical",
    player:  { name: "Magnus Carlsen", id: "drnykterstein", title: "GM", rating: 2862, color: "white" },
